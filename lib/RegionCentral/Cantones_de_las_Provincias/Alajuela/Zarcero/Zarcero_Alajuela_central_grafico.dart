...
class GraficaRegionCentralZarceroAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralZarceroAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralZarceroAlajuela.withSampleData() {
    return new GraficaRegionCentralZarceroAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Cantón Zarcero'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(61, Color(0xff01a9b4), 'Teléfono Fijo'),
      new centralData(88, Color(0xff87dfd6), 'Celular'),
      new centralData(15, Color(0xfffbfd8a), 'TV'),
      new centralData(95, Color(0xff111d5e), 'TV sin Cable'),
      new centralData(58, Color(0xffc70039), 'TV Cable/Satelital'),
      new centralData(34, Color(0xfff37121), 'Computadora'),
      new centralData(23, Color(0xffffbd69), 'Laptop'),
