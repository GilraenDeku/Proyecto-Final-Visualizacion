...
class GraficaRegionCentralPoasAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralPoasAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralPoasAlajuela.withSampleData() {
    return new GraficaRegionCentralPoasAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Cantón Poás'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(35, Color(0xffc70039), 'TV Cable/Satelital'),
      new centralData(33, Color(0xfff37121), 'Computadora'),
      new centralData(21, Color(0xffffbd69), 'Laptop'),
      new centralData(25, Color(0xffe36387), 'Internet'),
    ];
