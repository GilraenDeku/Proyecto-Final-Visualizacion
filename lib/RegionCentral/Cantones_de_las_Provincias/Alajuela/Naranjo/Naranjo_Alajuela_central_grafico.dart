...
class GraficaRegionCentralNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralNaranjoAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralNaranjoAlajuela.withSampleData() {
    return new GraficaRegionCentralNaranjoAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Cantón Naranjo'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(16, Color(0xfffbfd8a), 'TV'),
      new centralData(93, Color(0xff111d5e), 'TV sin Cable'),
      new centralData(33, Color(0xffc70039), 'TV Cable/Satelital'),
