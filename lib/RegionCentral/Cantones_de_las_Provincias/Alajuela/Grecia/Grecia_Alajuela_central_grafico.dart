...
class GraficaRegionCentralGreciaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralGreciaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralGreciaAlajuela.withSampleData() {
    return new GraficaRegionCentralGreciaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Cantón Grecia'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(21, Color(0xfffbfd8a), 'TV'),
      new centralData(91, Color(0xff111d5e), 'TV sin Cable'),
      new centralData(40, Color(0xffc70039), 'TV Cable/Satelital'),
