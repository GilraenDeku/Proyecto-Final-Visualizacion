...
class GraficaRegionCentralPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralPalmaresAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralPalmaresAlajuela.withSampleData() {
    return new GraficaRegionCentralPalmaresAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Cantón Palmares'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(94, Color(0xff111d5e), 'TV sin Cable'),
      new centralData(39, Color(0xffc70039), 'TV Cable/Satelital'),
      new centralData(40, Color(0xfff37121), 'Computadora'),
