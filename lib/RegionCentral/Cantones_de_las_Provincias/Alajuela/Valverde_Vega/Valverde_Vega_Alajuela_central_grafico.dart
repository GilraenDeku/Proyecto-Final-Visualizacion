...
class GraficaRegionCentralValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralValverdeVegaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralValverdeVegaAlajuela.withSampleData() {
    return new GraficaRegionCentralValverdeVegaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Cantón Valverde Vega'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(65, Color(0xff01a9b4), 'Teléfono Fijo'),
      ...
      new centralData(25, Color(0xffc70039), 'TV Cable/Satelital'),
      new centralData(30, Color(0xfff37121), 'Computadora'),
      new centralData(22, Color(0xffffbd69), 'Laptop'),
      new centralData(26, Color(0xffe36387), 'Internet'),
    ];
